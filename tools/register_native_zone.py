#!/usr/bin/env python3
"""Register only the approved full native Northline review and capture boundary.
...
visual='tests/presentation/northline_native_zone_contract.gd'
command='tests/tooling/run_northline_native_zone_gate.py'
headless='tools/migrate_northline_zone_native.gd'
...
for group,name,purpose in [('active_visual_entrypoints',visual,'original-PNG nine-district native TileMapLayer map and guarded 1080 capture'),('active_command_entrypoints',command,'native 1080 full map, four collision routes and edit reopening')]:
...
print('NATIVE_ZONE_REGISTRATION_COMPLETE')
