...
func begin(parent: Node, store: ProfileStore, request_id: String, profile_generation: int,
		seed: int, map_descriptor: Dictionary = {}, population_descriptor: Dictionary = {}) -> bool:
	...
	var committed := settlement.deploy(request_id,profile_generation,map_descriptor,population_descriptor)
