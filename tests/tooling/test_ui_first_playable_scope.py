...
class FirstPlayable1080GateTests(unittest.TestCase):
    ...
    def test_manifest_inventory_is_complete_and_independent(self) -> None:
        ...
        self.assertEqual(35, len(self.manifest["active_visual_entrypoints"]))
        self.assertEqual(65, len(self.manifest["active_headless_entrypoints"]))
        self.assertIn("tests/equipment/weapon_presentation_contract.gd",
...
'''
    ...
    def test_capture_writer_inventory_and_guards_are_complete(self) -> None:
        ...
        self.assertEqual(18, len(self.manifest["sanctioned_capture_writers"]))
